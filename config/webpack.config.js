...
const webpackPluginToCreateHtml = require('./webpackPluginToCreateHtml');
...
module.exports = function (webpackEnv) {
    ...
    // console.log(webpackPluginToCreateHtml(webpackEnv));
    ...
    return {
        ...
        entry: paths.entryNames, //paths.appIndexJs,
        output: {
            // The build folder.
            path: paths.appBuild,
        ...
        plugins: [
            ...
            ...webpackPluginToCreateHtml(webpackEnv),
