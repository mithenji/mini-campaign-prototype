...
let geom = new THREE.LatheBufferGeometry(pts, 20);
geoms.push(geom);

let geomLight = new THREE.CylinderBufferGeometry(0.1, 0.1, 0.05, 20);
//geomLight.rotateX(Math.PI * 0.5);
geoms.push(geomLight);

let fullGeom = THREE.BufferGeometryUtils.mergeBufferGeometries(geoms);
